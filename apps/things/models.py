...
class Equipment(models.Model):
    ...
    equip_picture = models.ImageField(upload_to="image/image_equipment/%Y/%m",
                                      default=u"image/image_equipment/default.png", max_length=100,
                                      verbose_name=u"设备图片")
...
class Software(models.Model):
    ...
    software_image = models.ImageField(upload_to="image/image_software/%Y/%m",
                                       default=u"image/image_software/default.png", max_length=100,
                                       verbose_name=u"软件图片")
...
class Technology(models.Model):
    ...
    tech_image = models.ImageField(upload_to="image/image_technology/%Y/%m",
                                   default=u"image/image_technology/default.png", max_length=100, verbose_name=u"技术图片")
